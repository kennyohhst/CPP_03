...
/*   Updated: 2024/02/15 18:59:04 by code             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap() : _name("stock bob"), _hit(10), _energy(10), _attack(0)
{
	std::cout << "Default constructor called" << std::endl;
}

ClapTrap::ClapTrap(std::string value) :  _name(value), _hit(10), _energy(10), _attack(0)
{
...
void ClapTrap::beRepaired(unsigned int amount)
{
	...
	{
		std::cout << "ClapTrap " << this->_name << " has repaired " << this->_energy << " amount of points which brings total to " << this->_hit+this->_energy << std::endl;
		this->_hit += this->_energy;
		this->_energy = 0;
	}
	else
	{
		std::cout << "ClapTrap " << this->_name << " has repaired " << amount << " amount of points which brings total to " << this->_hit+amount << std::endl;
		this->_hit += amount;
		this->_energy -= amount;
	}
